/**
 * Based on jsPsychImageButtonResponse by Josh de Leeuw
 * But prompt is above the buttons rather than below.
 **/

var jsPsychImageButtonResponsePromptAboveButtons = (function (jspsych) {
  'use strict';

  const info = {
      name: "image-button-response-promptabovebuttons",
      parameters: {
      ...
      trial(display_element, trial) {
          ...
          if (trial.render_on_canvas) {
              ...
              // add prompt if there is one 
                if (trial.prompt !== null) { // add buttons to screen 
                    var prompt_p = document.createElement('p'); 
                    prompt_p.innerHTML = trial.prompt; 
                    display_element.insertBefore(prompt_p, null); 
                } 
              // add buttons to screen
              display_element.insertBefore(btngroup_div, null);
