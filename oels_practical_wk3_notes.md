...
- The `preamble` paramiter is an html-formatted string, so I use some of the tricks you have seen elsewhere (paragrpah tags, emphasis tags) to make it look how I want.
